...
const CommandOutputModal = ({ title, output, error, onClose }) => {
  const isError = !!error;
    ...
    >
      <div className="space-y-4">
        ...
        <div className="bg-gray-900 overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700 shadow-inner">
          ...
          <pre className="p-4 text-xs font-mono text-gray-300 overflow-x-auto max-h-[300px] overflow-y-auto custom-scrollbar">
            {error || output || 'No standard output recorded.'}
          </pre>
        </div>
